...
function contenido (){
    ...
    fetch("./data/data.json")
        ...
        document.addEventListener('DOMContentLoaded', contenido); //cambio se encapsula el fetch de contenido para mayor maejo y garantizar su carga luego de cargar el sitio